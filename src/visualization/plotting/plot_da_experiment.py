...
DEFAULT_METRICS = [
    ("cos_emb | memory 3 | 30x30 - mean", "cos_emb_3"),
    ("cos_pixel | memory 3 | 30x30 - mean", "cos_pix_3"),
    ("cos_emb | memory 1 | 30x30 - mean", "cos_emb_1"),
    ("cos_pixel | memory 1 | 30x30 - mean", "cos_pix_1"),
]


def main():
    parser = argparse.ArgumentParser(
        description='Plot augmentation experiment summaries from W&B run ids.'
    )
