...
def main():
    ...
    if True:
        ...
        for batch_n in range(number_of_batches):
            ...
            distances = twin_ae_change_score(model, tensor_sample_1, tensor_sample_2)
    ...
    try:
        ...
        save_plot(image_numpy[0], "prediction")
    ...
    try:
        ...
        png.from_array(normalised, 'L').save("prediction_gray.png")
    except:
